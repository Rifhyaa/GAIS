...
{
    public class BarangVendorController : Controller
    {
        // Entities
        ...
        public ActionResult Index()
        {
            ...
            var lists = entities.BarangVendors.Where(x => x.RowStatus == 0);
        ...
        public ActionResult Details(int ID)
        {
            ...
            BarangVendor lists = entities.BarangVendors.Where(x => x.ID == ID).FirstOrDefault();
            if (lists == null)
            {
        ...
        [HttpPost]
        public ActionResult Create(BarangVendor mdat)
        {
            if (ModelState.IsValid)
            {
                ...
                entities.BarangVendors.Add(mdat);
        ...
        [HttpPost]
        public ActionResult Edit(BarangVendor mdat)
        {
            // Get Data By ID
            BarangVendor myData = entities.BarangVendors.Where(x => x.ID.Equals(mdat.ID)).FirstOrDefault();
        ...
        {
            // Get Data By ID
            BarangVendor data = entities.BarangVendors.Where(x => x.ID == ID).FirstOrDefault();
